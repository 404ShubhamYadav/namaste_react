...
import useRestaurantMenu from '../costum-hooks/useRestaurantMenu';
        ...
        <div className="max-w-[900px] mx-auto p-[15px]">
            ...
            <div className="menu-card">
                ...
                <div>
                 ...
                 {/* This is the Address details of clicked that particular restaurant */}
                    ...
                    {restaurantMenu
                        ...
                        .map((category, index) => (
                            <div key={index} className="flex items-center gap-4">
                                <img
                                    className="w-24 h-12"
                                    src={IMG_URL + category?.card?.card?.imageId}
